...
#define FCELL_TYPE float
#define G_SURFACE_TYPE FCELL_TYPE
typedef FCELL_TYPE surface_type;
typedef FCELL_TYPE FCELL;
...
typedef struct grid_header {
    grid_header(){};
    grid_header(dimensionType ncols, dimensionType nrows, double xllcorner,
                double yllcorner, double ew_res, double ns_res,
    ...
    surface_type nodata_value =
        NOVALUE; /*the value that represents missing data */
